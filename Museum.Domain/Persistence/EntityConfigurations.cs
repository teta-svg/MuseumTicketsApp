...
namespace Museum.Domain.Persistence
{
    ...
    public class MuseumConfiguration : IEntityTypeConfiguration<Domain.Entities.Museum>
    {
        public void Configure(EntityTypeBuilder<Domain.Entities.Museum> builder)
        {
